...
export function TextFieldExamples() {
  ...
  return (
    <div className="u-margin-bottom" style={{ width: '420px' }}>
      ...
      <TextField label="Controlled - no onChange" id="textfield-2" value="hello" charCounter maxLength={100} />
      <TextField label="Error" id="textfield-3" description="There is an error" state="error" type="password" />
      <TextField label="Small success" id="textfield-3" description="Ok!" state="success" size="small" />
    </div>
  );
}
