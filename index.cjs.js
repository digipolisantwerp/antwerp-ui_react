...
var Icon = function Icon(_ref) {
  ...
  var iconClass = classNames__default['default'](className, 'fa fa-' + name + ' ' + name);

  return React__default['default'].createElement(React__default['default'].Fragment, null, React__default['default'].createElement('span', { className: iconClass, style: style, 'data-qa': qa, 'aria-hidden': 'true', onClick: onClick }), ariaLabel && React__default['default'].createElement('span', { className: 'u-screen-reader-only' }, ariaLabel));
};
...
var Button = function (_Component) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var btnClass = classNames__default['default'](className, (_classNames = {
      ...
      return React__default['default'].createElement('button', {
        ...
        'data-qa': qa }, icon ? React__default['default'].createElement(Icon, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon, { name: iconRight }) : null, children);
    }
  }]);
...
var Alert = function (_Component) {
  ...
  _createClass$1(Alert, [{
    ...
    value: function render() {
      ...
      var alertClass = classNames__default['default']('m-alert', _defineProperty$1({}, '' + typeClasses$1[type], !!type), className);

      var closeButton = closable ? React__default['default'].createElement(Button, { type: type, icon: 'close', onClick: this.handleClose, className: 'm-alert__close a-button-transparent', 'aria-label': ariaLabelClose }) : null;

      return React__default['default'].createElement('div', null, !closed ? React__default['default'].createElement('div', { className: alertClass, 'data-qa': qa }, closeButton, title && React__default['default'].createElement('h5', { className: 'u-margin-bottom-xs' }, title), children) : React__default['default'].createElement('div', null));
    }
  }]);
...
var TagList = function TagList(_ref) {
    ...
    return React__default['default'].createElement("ul", { className: "o-tag-list" }, children);
};
    ...
    _createClass$2$1(Button, [{
        ...
        value: function render() {
            ...
            return React__default['default'].createElement('button', {
                ...
                type: htmlType,
                'aria-label': ariaLabel,
                'data-qa': qa }, icon ? React__default['default'].createElement(Icon$1, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon$1, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon$1, { name: iconRight }) : null, children);
        }
    }]);
...
var TagListItem = function (_Component) {
    ...
    _createClass$1$1$1(TagListItem, [{
        ...
        value: function render() {
            ...
            return React__default['default'].createElement('li', { className: 'm-tag', 'data-qa': qa }, icon && React__default['default'].createElement(Button$1, { size: 'small', icon: icon, ariaLabel: ariaLabelIcon }), React__default['default'].createElement('span', { className: 'm-tag__label' }, value), closable && React__default['default'].createElement(Button$1, { transparent: true, size: 'small', type: 'danger', icon: 'close', ariaLabel: ariaLabelClose, onClick: onClick }));
        }
    }]);
...
var InputLabel = function InputLabel(props) {
    ...
    var labelClass = classNames__default['default']('a-input__label', {
        'a-input__label--inline': !!inline
    });
    return React__default['default'].createElement('label', { className: labelClass, htmlFor: htmlFor, style: style, 'data-qa': qa }, children);
};
...
var TextField = function (_Component) {
    ...
    _createClass$5(TextField, [{
        ...
        value: function render() {
            ...
            var inputClass = classNames__default['default']('a-input', (_classNames = {
            ...
            return React__default['default'].createElement('div', { className: inputClass, 'data-qa': qa }, label && React__default['default'].createElement(InputLabel, { htmlFor: id }, label), React__default['default'].createElement('div', { className: 'a-input__wrapper' }, addonleft ? React__default['default'].createElement('div', { className: 'a-input__addon' }, addonleft) : null, iconleft ? React__default['default'].createElement(Icon$2, { name: iconleft }) : null, mask ? React__default['default'].createElement(InputMask__default['default'], this.props) : React__default['default'].createElement('input', _extends({ id: id, type: type, autoComplete: autoComplete, disabled: disabled,
                ref: function (_ref) {
                    function ref(_x) {
                ...
                }) }, extraProps)), iconright ? React__default['default'].createElement(Icon$2, { name: iconright }) : null, loading ? React__default['default'].createElement(Icon$2, { name: 'spinner', className: 'a-spinner a-spinner--sm' }) : null, addonright ? React__default['default'].createElement('div', { className: 'a-input__addon' }, addonright) : null), description ? React__default['default'].createElement('small', null, description) : null, errorDescription && React__default['default'].createElement('small', { className: 'u-text-danger' }, errorDescription));
        }
    }]);
...
var Autocomplete = function (_Component) {
    ...
    function Autocomplete() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn$3(this, (_ref = Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call.apply(_ref, [this].concat(args))), _this), _this.autocompleteRef = React__default['default'].createRef(), _this.state = {
            ...
            var domNode = ReactDOM__default['default'].findDOMNode(_this['item_' + _this.state.cursor]);
            domNode.scrollIntoView(false);
        }, _this.handleOutsideClick = function (e) {
            var area = ReactDOM__default['default'].findDOMNode(_this.autocompleteRef.current);
            if (area && !area.contains(e.target)) {
                _this.closePane();
            }
        }, _this.renderItems = function (item, index) {
            var liClasses = classNames__default['default']({
                'm-selectable-list__item': true,
                'm-selectable-list__item--active': _this.state.cursor === index
            });
            return React__default['default'].createElement('li', { key: item.value, 'data-value': item.value, 'data-label': item.label, className: liClasses,
    ...
    _createClass$6(Autocomplete, [{
        ...
        value: function getInput() {
            ...
            return React__default['default'].createElement('input', { id: this.props.id,
                type: 'text',
                autoComplete: 'off',
        ...
        value: function render() {
            ...
            var flyoutClasses = classNames__default['default']('m-flyout', 'm-flyout--full', 'm-autocomplete', {
                'is-open': open,
            ...
            var wrapperClasses = classNames__default['default']('a-input__wrapper', {
                'has-focus': !!this.inputField && this.inputField === document.activeElement && !!this.props.multipleSelect
            });

            var newEntryClasses = classNames__default['default']({
                'm-selectable-list__item': true,
                'm-selectable-list__item--active': this.state.cursor === 0
            });

            return React__default['default'].createElement('div', null, React__default['default'].createElement('div', { className: flyoutClasses, ref: this.autocompleteRef }, React__default['default'].createElement('div', { className: inputClass, 'data-qa': qa }, React__default['default'].createElement(InputLabel, { htmlFor: this.props.id }, this.props.label), React__default['default'].createElement('div', { className: wrapperClasses, onClick: function onClick() {
                    return _this6.focusOnInput();
                } }, this.props.multipleSelect && React__default['default'].createElement(TagList, null, this.state.selection.filter(function (s) {
                return !!s;
            }).map(function (s) {
                return React__default['default'].createElement(TagListItem, { closable: true, onClick: function onClick() {
                        return _this6.selectionMode.unselect(s);
                    }, key: s.value,
                    value: s.label });
            }), React__default['default'].createElement('li', { className: 'm-tag has-input' }, this.props.multipleSelect && this.getInput())), !this.props.multipleSelect && this.getInput(), this.props.showSearchIcon && React__default['default'].createElement(Icon$1$1, { name: 'search' }), (loading || isLoading) && React__default['default'].createElement(Icon$1$1, { name: 'spinner', className: 'a-spinner a-spinner--sm' }))), React__default['default'].createElement(FlyoutContent, { hasPadding: false }, results.length === 0 && !allowNewEntry || results.length === 0 && allowNewEntry && this.inputField && !this.inputField.value ? React__default['default'].createElement('p', { className: 'u-margin-xs u-text-light u-text-center' }, noResults || "Geen resultaten") : React__default['default'].createElement('ul', { className: 'm-selectable-list m-selectable-list--no-border' }, allowNewEntry && this.inputField && this.inputField.value && React__default['default'].createElement('li', { className: newEntryClasses, onClick: function onClick() {
...
var IconWrapper = function IconWrapper(_ref) {
  var icon = _ref.icon;
  return React__default['default'].createElement('span', { className: 'a-avatar__icon' }, React__default['default'].createElement(Icon$3, { name: icon }));
};
var LetterWrapper = function LetterWrapper(_ref2) {
  var letter = _ref2.letter;
  return React__default['default'].createElement('span', { className: 'a-avatar__letter' }, letter);
};
...
var Avatar = function Avatar(props) {
  ...
  var avatarClass = classNames__default['default']('a-avatar', _defineProperty$3({}, '' + sizeClasses$2[size], !!size), className);

  return React__default['default'].createElement('div', { className: avatarClass, style: style, 'data-qa': qa }, icon && React__default['default'].createElement(IconWrapper, { icon: icon }), letter && React__default['default'].createElement(LetterWrapper, { letter: letter }), image && React__default['default'].createElement('img', { src: image, alt: alt }), children, React__default['default'].createElement('span', { className: 'u-screen-reader-only' }, ariaLabel));
};
...
var Badge = function Badge(props) {
  ...
  var badgeClass = classNames__default['default']('a-badge', className, _defineProperty$4({}, '' + typeClasses$3[type], !!type));

  return React__default['default'].createElement('span', { className: badgeClass, title: ariaLabel, 'aria-label': ariaLabel, style: style, 'data-qa': qa }, children);
};
  ...
  _createClass$7(Button, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('button', {
        ...
        type: htmlType,
        'aria-label': ariaLabel,
        'data-qa': qa }, icon ? React__default['default'].createElement(Icon$4, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon$4, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon$4, { name: iconRight }) : null, children);
    }
  }]);
...
var ButtonGroup = function ButtonGroup(props) {
  ...
  var className = classNames__default['default']('m-button-group', {
    'm-button-group--vertical': direction === 'vertical'
  });

  return React__default['default'].createElement('div', { className: className, style: style, 'data-qa': qa }, children);
};
  ...
  _createClass$8(Button, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('button', {
        ...
        type: htmlType,
        'aria-label': ariaLabel,
        'data-qa': qa }, icon ? React__default['default'].createElement(Icon$5, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon$5, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon$5, { name: iconRight }) : null, children);
    }
  }]);
...
var Nav = function (_Component) {
  ...
  _createClass$1$2(Nav, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement(React__default['default'].Fragment, null, React__default['default'].createElement(Button$3, {
        htmlType: 'button',
        onClick: onClickPrevious,
        className: 'a-button has-icon',
        icon: 'angle-left',
        ariaLabel: ariaLabelPrevious(viewType, displayedPeriod)
      }), React__default['default'].createElement(Button$3, { htmlType: 'button', onClick: onClickViewType, className: 'm-datepicker__title a-button u-text-capitalize' }, this.renderNav()), React__default['default'].createElement(Button$3, {
        htmlType: 'button',
        onClick: onClickNext,
        className: 'a-button has-icon',
        icon: 'angle-right',
  ...
  _createClass$2$2(Rows, [{
    ...
    value: function generateRows() {
      ...
      return list.map(function (content, index) {
        return React__default['default'].createElement("td", { key: index }, React__default['default'].createElement("button", { className: "u-text-capitalize", tabIndex: index, value: content, onClick: onClick, type: "button" }, content.replace(/\./g, ' ')));
        ...
        return React__default['default'].createElement("tr", { key: index }, rowContent);
      });
    }
  }, {
    key: "render",
...
var Day = function (_Component) {
  ...
  _createClass$3$1(Day, [{
    ...
    value: function render() {
      ...
      if (day.isSame(Moment__default['default'](), 'day')) {
      ...
      return React__default['default'].createElement('td', null, React__default['default'].createElement('button', {
...
var Body = function (_Component) {
  ...
  function Body() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$4$1(this, (_ref = Body.__proto__ || Object.getPrototypeOf(Body)).call.apply(_ref, [this].concat(args))), _this), _this.handleOnClick = function (type, event) {
      ...
      if (type === 'days') {
        newDisplayedPeriod = Moment__default['default'](displayedPeriod.format('YYYY') + value, "YYYY MMM");
      } else if (type === 'months') {
        newDisplayedPeriod = Moment__default['default'](displayedPeriod.format('MM') + value, "MM YYYY");
      }
  ...
  _createClass$4$1(Body, [{
    ...
    value: function renderWeeks(displayMonth) {
      ...
      return _weekEnum.map(function (week, key) {
        return React__default['default'].createElement('tr', { key: key }, _this2.renderDay(_daysOfMonth, week));
      });
    }
  }, {
    key: 'renderListMonths',
    value: function renderListMonths() {
      var months = Moment__default['default'].monthsShort();
      return React__default['default'].createElement(Rows, { list: months, rowLength: 4, onClick: this.handleOnClick.bind(this, 'days') });
    }
  }, {
    key: 'renderListYears',
    value: function renderListYears(displayMonth) {
      var years = yearsOfMonth(displayMonth);
      return React__default['default'].createElement(Rows, { list: years, rowLength: 4, onClick: this.handleOnClick.bind(this, 'months') });
    }
  }, {
    key: 'renderDay',
    value: function renderDay(_daysOfMonth, week) {
      ...
      return days.map(function (day, key) {
        ...
        selectedDates.forEach(function (selectedDate) {
          if (date.isSame(Moment__default['default'](selectedDate, format), 'day')) {
            selected = true;
            dayPrevMonth = false;
            dayNextMonth = false;
          }
        ...
        return React__default['default'].createElement(Day, {
          key: key,
          day: date,
...
var Head = function (_Component) {
  ...
  _createClass$5$1(Head, [{
    ...
    value: function renderNameOfDays() {
      ...
      var nameOfDays = Moment__default['default'].weekdaysMin(true);
      var longNameDays = Moment__default['default'].weekdays(true);
      var orderedLongNameDays = rotateArrayByPosition(longNameDays, 2);

      return React__default['default'].createElement('tr', { className: 'm-datepicker__days' }, nameOfDays.map(function (day, i) {
        return React__default['default'].createElement('th', { key: i, className: 'u-text-capitalize', 'aria-label': orderedLongNameDays[i] }, day);
      }));
    }
  }, {
    key: 'render',
...
var Calendar = function (_Component) {
  ...
  function Calendar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$6(this, (_ref = Calendar.__proto__ || Object.getPrototypeOf(Calendar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      displayedPeriod: _this.props.activeDate ? Moment__default['default'](_this.props.activeDate, _this.props.format) : Moment__default['default'](),
      viewType: 'days',
  ...
  _createClass$6$1(Calendar, [{
    ...
    value: function render() {
      ...
      })), React__default['default'].createElement('table', null, React__default['default'].createElement('thead', null, React__default['default'].createElement(Head, { displayedPeriod: displayedPeriod, viewType: viewType })), React__default['default'].createElement('tbody', { className: 'm-datepicker__calendar' }, React__default['default'].createElement(Body, {
        viewType: viewType,
        displayedPeriod: displayedPeriod,
...
var DatePicker = function DatePicker(_ref) {
  var clickOnDate = _ref.clickOnDate,
      ...
      qa = _ref.qa;
  return React__default['default'].createElement(Calendar, {
...
var Calendar$1 = function (_Component) {
  ...
  function Calendar(props) {
    ...
    Moment__default['default'].locale(locale ? locale : 'nl');

    _this.state = {
      activeDate: activeDate ? Moment__default['default'](activeDate, format) : ''
    };
    return _this;
  }
  ...
  _createClass$7$1(Calendar, [{
    ...
    value: function changeDate(day) {
      ...
      if (onChange) onChange(Moment__default['default'](day).format(format));
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('div', { className: 'm-datepicker is-open', 'data-qa': qa }, React__default['default'].createElement(DatePicker, {
        format: format,
        locale: locale,
        activeDate: activeDate,
        selectedDates: selectedDates,
        minDate: Moment__default['default'](minDate, format),
        maxDate: Moment__default['default'](maxDate, format),
        noWeekends: noWeekends,
        ariaLabelPrevious: ariaLabelPrevious,
        ariaLabelNext: ariaLabelNext,
        ariaLabelDatePicker: ariaLabelDatePicker,
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.activeDate) {
        return {
          activeDate: Moment__default['default'](nextProps.activeDate, nextProps.format)
        };
      }
...
var Card = function (_Component) {
  ...
  _createClass$9(Card, [{
    ...
    value: function render() {
      ...
      var cardClass = classNames__default['default']('m-card', className);

      return React__default['default'].createElement('div', { className: cardClass, style: style, 'data-qa': qa }, children);
    }
  }]);
...
var Contact = function Contact(props) {
  ...
  return React__default['default'].createElement("div", { className: "m-contact", style: style, "data-qa": qa }, avatar, React__default['default'].createElement("div", { className: "m-contact__info" }, React__default['default'].createElement("p", { className: "u-text-bold" }, name), info && React__default['default'].createElement("p", { className: "small" }, info)));
};
...
var CardHeader = function CardHeader(props) {
  ...
  var cardHeader = React__default['default'].createElement('div', { className: 'm-card__header', style: { display: 'flex' } }, React__default['default'].createElement(Contact, {
    avatar: avatar,
    name: title,
    style: { flex: 1, whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' } }), React__default['default'].createElement('div', { style: { float: 'right', textAlign: 'right' } }, actions));
...
var CardBody = function CardBody(props) {
  ...
  return React__default['default'].createElement("div", { className: "m-card__body", style: style }, children);
};
...
var CardTitle = function CardTitle(props) {
  ...
  return React__default['default'].createElement("h5", { className: "u-margin-bottom-xs", style: style }, children);
};
...
var CardDescription = function CardDescription(props) {
  ...
  return React__default['default'].createElement('p', { style: style }, children);
};

var CardActions = function CardActions(_ref) {
  var children = _ref.children,
      className = _ref.className;
  return React__default['default'].createElement('div', { className: classNames__default['default']('pull-right u-margin-bottom-xs', className) }, children);
};
...
var CardIcon = function CardIcon(_ref) {
  var icon = _ref.icon,
      className = _ref.className,
      ariaLabel = _ref.ariaLabel;
  return React__default['default'].createElement('div', { className: classNames__default['default']('pull-left u-margin-right u-margin-bottom', className) }, React__default['default'].createElement(Icon$6, { name: icon, className: 'fa-lg u-text-light', ariaLabel: ariaLabel }));
};
...
var CardImage = function CardImage(_ref) {
  var src = _ref.src,
      alt = _ref.alt,
      className = _ref.className;
  return React__default['default'].createElement('div', { className: classNames__default['default']('pull-left u-margin-right', className) }, React__default['default'].createElement('div', { className: 'a-avatar a-avatar--small' }, React__default['default'].createElement('img', { src: src, alt: alt })));
};
...
var Content = function Content(props) {
  ...
  var contentClass = classNames__default['default']('u-wrapper', className);
  return React__default['default'].createElement('div', { className: contentClass }, React__default['default'].createElement('div', { className: 'u-container', 'data-qa': qa }, children));
};
...
var FlyoutContent$1 = function FlyoutContent(props) {
  ...
  var classes = classNames__default['default']('m-flyout__content', {
    'has-padding': !!hasPadding
  });

  return React__default['default'].createElement('div', { className: classes, 'data-qa': qa }, children);
};
...
var Flyout = function (_Component) {
  ...
  function Flyout() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$9(this, (_ref = Flyout.__proto__ || Object.getPrototypeOf(Flyout)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.flyoutRef = React__default['default'].createRef(), _this.toggleIsOpen = function () {
      ...
      var area = ReactDOM__default['default'].findDOMNode(_this.flyoutRef.current);
      if (area && !area.contains(e.target)) {
        _this.closeFlyout();
      }
    }, _this.getClassNames = function () {
      return classNames__default['default'](_this.props.className, 'm-flyout', 'm-flyout--' + _this.props.direction, _defineProperty$7({
  ...
  _createClass$a(Flyout, [{
    ...
    value: function render() {
      ...
      return trigger && React__default['default'].createElement('div', { className: flyoutClass, ref: this.flyoutRef, 'aria-haspopup': 'true', 'aria-expanded': open, 'data-qa': qa }, React__default['default'].createElement('div', { onClick: this.toggleIsOpen }, this.props.trigger), React__default['default'].createElement(FlyoutContent$1, { hasPadding: hasPadding }, children));
    }
  }]);
  ...
  _createClass$b(Button, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('button', {
        ...
        type: htmlType,
        'aria-label': ariaLabel,
        'data-qa': qa }, icon ? React__default['default'].createElement(Icon$7, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon$7, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon$7, { name: iconRight }) : null, children);
    }
  }]);
...
var FlyoutButton = function (_Component) {
  ...
  function FlyoutButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$1$3(this, (_ref = FlyoutButton.__proto__ || Object.getPrototypeOf(FlyoutButton)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return classNames__default['default']('m-flyout', 'm-flyout--' + _this.props.flyoutDirection, _defineProperty$1$2({
        'is-open': _this.state.isOpen
  ...
  _createClass$1$3(FlyoutButton, [{
    ...
    value: function render() {
      ...
      var flyoutClass = this.getClassNames();
      return React__default['default'].createElement('div', { className: flyoutClass, ref: function ref(_ref2) {
          _this2.containerRef = _ref2;
        }, 'aria-haspopup': 'true', 'aria-expanded': isOpen, 'data-qa': qa }, React__default['default'].createElement(Button$4, _extends$1({}, buttonProps, { onClick: this.toggleIsOpen }), label), React__default['default'].createElement(FlyoutContent$2, { hasPadding: flyoutHasPadding }, this.props.children));
    }
  }]);
...
var Footer = function Footer(props) {
  ...
  return React__default['default'].createElement('footer', { className: 'o-footer', style: style, 'data-qa': qa }, React__default['default'].createElement('span', { className: 'o-footer__label' }, children || '© stad Antwerpen'), React__default['default'].createElement('a', { onClick: function onClick() {
      return scrollToTop();
    }, href: '#', className: 'o-footer__button a-button a-button--secondary has-icon', 'aria-label': ariaLabel }, React__default['default'].createElement(Icon$8, { name: 'arrow-up' })));
};
...
var Form = function Form(props) {
  ...
  return React__default['default'].createElement("form", { className: "a-form", style: style, onSubmit: onSubmit }, children);
};
...
var Fieldset = function Fieldset(props) {
  ...
  return React__default['default'].createElement('fieldset', { style: style, 'data-qa': qa }, React__default['default'].createElement('legend', null, legend), children);
};
...
var TextField$1 = function (_Component) {
  ...
  _createClass$c(TextField, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('div', { className: inputClass, 'data-qa': qa }, label && React__default['default'].createElement(InputLabel$1, { htmlFor: id }, label), React__default['default'].createElement('div', { className: 'a-input__wrapper' }, addonleft ? React__default['default'].createElement('div', { className: 'a-input__addon' }, addonleft) : null, iconleft ? React__default['default'].createElement(Icon$9, { name: iconleft }) : null, mask ? React__default['default'].createElement(InputMask__default['default'], this.props) : React__default['default'].createElement('input', _extends$2({ id: id, type: type, autoComplete: autoComplete, disabled: disabled,
        ref: function (_ref) {
          function ref(_x) {
            return _ref.apply(this, arguments);
          }
          ...
          return _this2.props.inputRef && _this2.props.inputRef(ref);
        }) }, extraProps)), iconright ? React__default['default'].createElement(Icon$9, { name: iconright }) : null, loading ? React__default['default'].createElement(Icon$9, { name: 'spinner', className: 'a-spinner a-spinner--sm' }) : null, addonright ? React__default['default'].createElement('div', { className: 'a-input__addon' }, addonright) : null), description ? React__default['default'].createElement('small', null, description) : null, errorDescription && React__default['default'].createElement('small', { className: 'u-text-danger' }, errorDescription));
    }
  }]);
...
var Checkbox = function (_Component) {
  ...
  _createClass$1$4(Checkbox, [{
    ...
    value: function render() {
      ...
      var inputClass = classNames__default['default']('a-input');

      var requiredLabel = !!required ? React__default['default'].createElement('span', { className: 'u-text-danger' }, ' *') : null;

      return React__default['default'].createElement('div', { className: inputClass, 'data-qa': qa }, React__default['default'].createElement('div', { className: 'a-input__checkbox' }, React__default['default'].createElement('input', _extends$1$1({
        type: 'checkbox',
        id: id,
        name: name,
        ...
        disabled: disabled
      }, this.props.handler)), React__default['default'].createElement(InputLabel$1, { htmlFor: id }, label, requiredLabel)));
    }
  }]);
...
var Option = function Option(props) {
  ...
  return React__default['default'].createElement('option', { value: value, disabled: disabled }, children);
};
...
var Spinner = function Spinner(props) {
  ...
  var spinnerClass = classNames__default['default']('a-spinner', className, _defineProperty$1$3({}, 'a-spinner--' + spinnerSizes[size], !!size));

  return React__default['default'].createElement('div', { className: spinnerClass, style: style, role: 'status', 'aria-label': ariaLabel, 'data-qa': qa });
};
...
var Select = function (_Component) {
  ...
  _createClass$2$3(Select, [{
    ...
    value: function render() {
      ...
      var selectClass = classNames__default['default']('a-input', 'has-icon-right', (_classNames = {
      ...
      var wrapperClass = classNames__default['default']('a-input__wrapper', {
        'a-input__wrapper--inline': !!inline
      });
      return React__default['default'].createElement('div', { className: selectClass, name: name, 'data-qa': qa }, label && React__default['default'].createElement(InputLabel$1, { inline: inline, htmlFor: id }, label), React__default['default'].createElement('div', { className: wrapperClass }, React__default['default'].createElement('select', { id: id, name: name, onChange: function onChange(e) {
          return _this2.onChange(e);
        }, defaultValue: this.state.value, disabled: disabled }, placeholder && React__default['default'].createElement('option', { value: '', disabled: true }, placeholder), options.map(function (option) {
      ...
      })), loading ? React__default['default'].createElement(Spinner, { size: 'small', className: 'fa' }) : React__default['default'].createElement(Icon$9, { name: 'angle-down', span: true })));
    }
  }]);
...
var Textarea = function Textarea(props) {
  ...
  var textareaClass = classNames__default['default']('a-input', (_classNames = {
    'is-required': !!required
  ...
  return React__default['default'].createElement('div', { className: textareaClass, style: style, 'data-qa': qa }, label && React__default['default'].createElement(InputLabel$1, { htmlFor: id }, label), React__default['default'].createElement('textarea', { id: id, placeholder: placeholder, name: name, value: value, onChange: onChange, onBlur: onBlur, disabled: disabled, required: required, onInvalidCapture: onInvalidCapture }));
};
...
var Radio = function Radio(props) {
  ...
  var radioClass = classNames__default['default']('a-input__radio');
  return React__default['default'].createElement('div', { className: radioClass, 'data-qa': qa }, React__default['default'].createElement('input', { type: 'radio', value: value, id: id, name: name, defaultChecked: checked, disabled: disabled, required: required }), React__default['default'].createElement('label', { htmlFor: id }, children));
};
...
var RadioGroup = function RadioGroup(props) {
  ...
  var radioGroupClass = classNames__default['default']('a-input', className, {
    'is-required': !!required
  });
  return React__default['default'].createElement('div', { className: radioGroupClass, style: style, onChange: onChange, 'data-qa': qa }, label && React__default['default'].createElement(InputLabel$1, { inline: inline }, label), React__default['default'].createElement('div', { className: 'a-input__wrapper' }, options.map(function (option) {
    return React__default['default'].createElement(Radio, {
      value: option.value,
  ...
  })), description ? React__default['default'].createElement('small', null, description) : null);
};
  ...
  _createClass$3$2(Button, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('button', {
        ...
        type: htmlType,
        'aria-label': ariaLabel,
        'data-qa': qa }, icon ? React__default['default'].createElement(Icon$1$2, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon$1$2, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon$1$2, { name: iconRight }) : null, children);
    }
  }]);
...
var Nav$1 = function (_Component) {
  ...
  _createClass$1$1$2(Nav, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement(React__default['default'].Fragment, null, React__default['default'].createElement(Button$5, {
        htmlType: 'button',
        onClick: onClickPrevious,
        className: 'a-button has-icon',
        icon: 'angle-left',
        ariaLabel: ariaLabelPrevious(viewType, displayedPeriod)
      }), React__default['default'].createElement(Button$5, { htmlType: 'button', onClick: onClickViewType, className: 'm-datepicker__title a-button u-text-capitalize' }, this.renderNav()), React__default['default'].createElement(Button$5, {
        htmlType: 'button',
        onClick: onClickNext,
        className: 'a-button has-icon',
        icon: 'angle-right',
...
var Body$1 = function (_Component) {
  ...
  _createClass$4$2(Body, [{
    ...
    value: function renderListMonths() {
      var months = Moment__default['default'].monthsShort();
      return React__default['default'].createElement(Rows$1, { list: months, rowLength: 4, onClick: this.handleOnClick.bind(this, 'days') });
    }
  }, {
    key: 'renderListYears',
    value: function renderListYears(displayMonth) {
      var years = yearsOfMonth$1(displayMonth);
      return React__default['default'].createElement(Rows$1, { list: years, rowLength: 4, onClick: this.handleOnClick.bind(this, 'months') });
    }
  }, {
    key: 'renderDay',
    value: function renderDay(_daysOfMonth, week) {
      ...
      return days.map(function (day, key) {
        ...
        return React__default['default'].createElement(Day$1, {
          key: key,
          day: date,
          selectDay: selectDay.bind(_this3, date),
          disabled: disabled,
  ...
  _createClass$6$2(Calendar, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement(React__default['default'].Fragment, null, React__default['default'].createElement('div', {
        ...
        'aria-label': '' + ariaLabelDatePicker(viewType),
        'aria-hidden': 'false'
      }, React__default['default'].createElement(Nav$1, {
        viewType: viewType,
        displayedPeriod: displayedPeriod,
        onClickPrevious: this.moveDisplayedPeriod.bind(this, -1),
        onClickViewType: this.changeViewType.bind(this),
        ...
        ariaLabelPrevious: ariaLabelPrevious,
        ariaLabelNext: ariaLabelNext
      })), React__default['default'].createElement('table', null, React__default['default'].createElement('thead', null, React__default['default'].createElement(Head$1, { displayedPeriod: displayedPeriod, viewType: viewType })), React__default['default'].createElement('tbody', { className: 'm-datepicker__calendar' }, React__default['default'].createElement(Body$1, {
        viewType: viewType,
        displayedPeriod: displayedPeriod,
        selectDay: selectDay.bind(this),
        selectedDates: selectedDates,
...
var DatePicker$1 = function DatePicker(_ref) {
  var clickOnDate = _ref.clickOnDate,
      ...
      ariaLabelButtonDateFormat = _ref.ariaLabelButtonDateFormat,
      qa = _ref.qa;
  return React__default['default'].createElement(Calendar$2, {
...
var Calendar$1$1 = function (_Component) {
  ...
  _createClass$7$2(Calendar, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('div', { className: 'm-datepicker is-open', 'data-qa': qa }, React__default['default'].createElement(DatePicker$1, {
        format: format,
        locale: locale,
        activeDate: activeDate,
        selectedDates: selectedDates,
...
var Datepicker = function (_Component) {
  ...
  _createClass$8$1(Datepicker, [{
    ...
    value: function changeDate(date) {
      ...
      var momentDate = Moment__default['default'](date, format, true);
    ...
    value: function render() {
      ...
      var datepickerWrapperClass = classNames__default['default']('a-input', 'has-icon-right', (_classNames = {
        'is-required': !!required
      }, _defineProperty$5$1(_classNames, '' + stateClasses$3[state], !!state), _defineProperty$5$1(_classNames, 'a-input--' + size, !!size), _classNames));

      var datepickerClass = classNames__default['default']('m-datepicker', 'm-datepicker--fixed', {
        'is-open': open
      });

      return React__default['default'].createElement('div', { className: datepickerWrapperClass, ref: function ref(node) {
          return _this2.datepicker = node;
        }, 'data-qa': qa }, label && React__default['default'].createElement(InputLabel$1, { htmlFor: id }, label), React__default['default'].createElement('div', { className: 'a-input__wrapper' }, React__default['default'].createElement(TextField$1, {
        mask: mask,
        name: name,
        id: id,
        value: input,
        ...
        onBlur: onBlur }), React__default['default'].createElement(Icon$9, { name: 'calendar', className: 'is-clickable', onClick: this.toggleCalendar.bind(this) }), open && React__default['default'].createElement('div', { className: datepickerClass, 'aria-hidden': 'false' }, React__default['default'].createElement('div', { className: 'm-datepicker is-open' }, React__default['default'].createElement(Calendar$1$1, {
        locale: locale,
        format: format,
        activeDate: activeDate,
        selectedDates: selectedDates,
      ...
      })))), description && React__default['default'].createElement('small', null, description));
    }
  }], [{
    key: 'getDerivedStateFromProps',
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (props.activeDate) {
        var momentDate = Moment__default['default'](props.activeDate, props.format, true);
...
var TelephoneNumber = function TelephoneNumber(props) {
  ...
  var _useState = React.useState(valueIsValidObject(value) ? value : {
  ...
  var telephoneNumberClass = classNames__default['default']('a-input', 'a-input-telephone', _defineProperty$6$1({
    'is-required': !!required
  }, '' + stateClasses$4[state], !!state), className);

  return React__default['default'].createElement('div', { className: telephoneNumberClass, style: style, 'data-qa': qa }, label && React__default['default'].createElement(InputLabel$1, { htmlFor: id }, label), React__default['default'].createElement('div', { className: 'a-input__wrapper' }, React__default['default'].createElement(Select, _extends$3({
    ...
    options: options
  }, extraProps)), React__default['default'].createElement(TextField$1, _extends$3({
  ...
  }, extraProps))), description ? React__default['default'].createElement('small', null, description) : null, errorDescription && React__default['default'].createElement('small', { className: 'u-text-danger' }, errorDescription));
};
...
var Header = function Header(props) {
	...
	var headerClass = classNames__default['default']('o-header', className, _defineProperty$a({}, env + '-header', type === 'antwerpen'));
	return React__default['default'].createElement('header', { className: headerClass, style: style, 'data-qa': qa }, React__default['default'].createElement('a', { href: logoUrl, className: 'o-header__logo' }, React__default['default'].createElement('img', { src: logoSrc, alt: logoAlt })), children);
};
...
var Hero = function Hero(props) {
  ...
  return React__default['default'].createElement('div', { className: 'u-wrapper u-bg-light', style: styles }, React__default['default'].createElement('div', { className: 'u-container' }, React__default['default'].createElement('div', { className: 'u-text-center u-margin-lg' }, children)));
};
...
var Label = function Label(props) {
  ...
  var labelClass = classNames__default['default']('a-label', className, _defineProperty$b({}, '' + typeClasses$8[type], !!type));

  return React__default['default'].createElement('span', { className: labelClass, style: style, 'data-qa': qa }, children);
};
...
var Steps = function (_Component) {
  ...
  _createClass$d(Steps, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement("div", { className: className, "data-qa": qa }, React__default['default'].createElement("ol", { className: "m-step-indicator" }, this.props.children.map(function (child, i) {
...
var Step = function (_Component) {
  ...
  _createClass$1$5(Step, [{
    ...
    value: function render() {
      ...
      var stepClass = classNames__default['default']({
        'is-active': !!active,
        'is-completed': !!completed
      });

      return React__default['default'].createElement('li', { className: stepClass }, !!completed ? React__default['default'].createElement('span', { className: 'u-screen-reader-only' }, ariaLabelCompleted) : '', !!active ? React__default['default'].createElement('span', { className: 'u-screen-reader-only' }, ariaLabelCurrent) : '', React__default['default'].createElement('span', { className: 'm-step-indicator__label' }, title));
    }
  }]);
...
var Handle = function (_Component) {
  ...
  _createClass$e(Handle, [{
    ...
    value: function render() {
      ...
      }, tooltips ? React__default['default'].createElement('div', { className: 'm-range-slider__tooltip a-tooltip a-tooltip--primary a-tooltip--top' }, React__default['default'].createElement('p', null, fixedValue.replace(/[.]/, ','), unit)) : React__default['default'].createElement('span', { className: 'm-range-slider__value' }, fixedValue.replace(/[.]/, ','), unit));
    }
  }], [{
    key: 'getDerivedStateFromProps',
    value: function getDerivedStateFromProps(props, state) {
...
var Slider = function (_Component) {
  ...
  _createClass$1$6(Slider, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('div', { id: id, 'data-qa': qa }, label && React__default['default'].createElement(InputLabel$2, { htmlFor: id }, label), React__default['default'].createElement('div', {
        className: 'm-range-slider',
        ref: function ref(s) {
          _this2.slider = s;
        }
      }, React__default['default'].createElement('div', { className: 'm-range-slider__inner' }, React__default['default'].createElement(Bar, {
        start: start,
        end: end,
      ...
      }), range && React__default['default'].createElement(Handle, {
        value: end,
...
var Spinner$1 = function Spinner(props) {
  ...
  var spinnerClass = classNames__default['default']('a-spinner', className, _defineProperty$c({}, 'a-spinner--' + spinnerSizes$1[size], !!size));
  ...
  _createClass$f(Breadcrumbs, [{
    ...
    value: function renderItems() {
      ...
      return items.map(function (item, index) {
        return React__default['default'].createElement('li', { key: item.name }, index >= items.length - 1 || !item.target && !item.onClick ? item.name : React__default['default'].createElement(Link, linkProps({
          href: item.target || '#',
    ...
    value: function render() {
      ...
      return items && items.length > 0 && React__default['default'].createElement('ul', { className: 'm-breadcrumbs', 'data-qa': qa }, this.renderItems());
    }
  }]);
...
var Switch = function (_Component) {
  ...
  _createClass$g(Switch, [{
    ...
    value: function render() {
      ...
      var containerClass = classNames__default['default']('a-input', { 'is-required': !!required });

      var switchWrapperClass = classNames__default['default']('a-switch', { 'disabled': disabled });

      return React__default['default'].createElement('div', { className: containerClass, 'data-qa': qa }, label && React__default['default'].createElement(InputLabel$3, null, label), React__default['default'].createElement('div', { className: switchWrapperClass }, labelFalse && React__default['default'].createElement('label', { className: 'a-switch__label' }, labelFalse), React__default['default'].createElement('div', { className: 'a-switch__toggle' }, React__default['default'].createElement('input', {
        type: 'checkbox',
        name: name,
        id: id,
        role: 'switch',
      ...
      }), React__default['default'].createElement('label', { htmlFor: id }, React__default['default'].createElement('span', { className: 'u-screen-reader-only' }, 'Toggle "', label, '"'))), labelTrue && React__default['default'].createElement('label', { className: 'a-switch__label' }, labelTrue)));
    }
  }]);
  ...
  _createClass$h(Tabs, [{
    ...
    value: function renderItems() {
      ...
      return items.map(function (item) {
        return React__default['default'].createElement('li', { key: item.name }, React__default['default'].createElement(Link$1, _extends$5({
          className: classNames__default['default']({ 'is-active': item.active, 'is-disabled': item.disabled })
        }, linkProps({ href: item.target })), item.active ? React__default['default'].createElement('span', { className: 'u-screen-reader-only' }, ariaLabelActive) : '', item.name));
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var tabClasses = classNames__default['default']('m-nav-tabs', {
        'm-nav-tabs--left': align === 'left',
        'm-nav-tabs--right': align === 'right'
      });

      return items && items.length > 0 && React__default['default'].createElement('ul', { className: tabClasses, 'data-qa': qa }, this.renderItems());
    }
  }]);
  ...
  _createClass$i(Button, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('button', {
        ...
        type: htmlType,
        'aria-label': ariaLabel,
        'data-qa': qa }, icon ? React__default['default'].createElement(Icon$b, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon$b, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon$b, { name: iconRight }) : null, children);
    }
  }]);
...
var TagListItem$1 = function (_Component) {
  ...
  _createClass$1$7(TagListItem, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('li', { className: 'm-tag', 'data-qa': qa }, icon && React__default['default'].createElement(Button$6, { size: 'small', icon: icon, ariaLabel: ariaLabelIcon }), React__default['default'].createElement('span', { className: 'm-tag__label' }, value), closable && React__default['default'].createElement(Button$6, { transparent: true, size: 'small', type: 'danger', icon: 'close', ariaLabel: ariaLabelClose, onClick: onClick }));
    }
  }]);
...
var Toggle = function (_Component) {
  ...
  _createClass$j(Toggle, [{
    ...
    value: function render() {
      ...
      var toggleClass = classNames__default['default']('a-toggle has-icon', _defineProperty$e({}, '' + sizeClasses$8[size], !!size));

      var checkedClasses = classNames__default['default']('a-toggle__on a-button', showLabels ? 'has-icon-left' : 'has-icon', (_classNames2 = {}, _defineProperty$e(_classNames2, '' + checkedButtonClass, checkedButtonClass), _defineProperty$e(_classNames2, '' + sizeBtnClasses[size], !!size), _classNames2));

      var uncheckedClasses = classNames__default['default']('a-toggle__off a-button', showLabels ? 'has-icon-left' : 'has-icon', (_classNames3 = {}, _defineProperty$e(_classNames3, '' + uncheckedButtonClass, uncheckedButtonClass), _defineProperty$e(_classNames3, '' + sizeBtnClasses[size], !!size), _classNames3));

      return React__default['default'].createElement('div', { className: toggleClass, 'data-qa': qa }, React__default['default'].createElement('input', {
        ...
        role: 'switch',
        onChange: this.handleChange
      }), React__default['default'].createElement('div', { className: 'a-toggle__labels' }, React__default['default'].createElement('label', { htmlFor: id, className: checkedClasses }, React__default['default'].createElement(Icon$c, { name: checkedIcon, ariaLabel: showLabels ? '' : checkedLabel }), showLabels && React__default['default'].createElement('span', null, checkedLabel)), React__default['default'].createElement('label', { htmlFor: id, className: uncheckedClasses }, React__default['default'].createElement(Icon$c, { name: uncheckedIcon, ariaLabel: showLabels ? '' : uncheckedLabel }), showLabels && React__default['default'].createElement('span', null, uncheckedLabel))));
    }
  }]);
...
var IconWrapper$1 = function IconWrapper(_ref) {
  var icon = _ref.icon;
  return React__default['default'].createElement('span', { className: 'a-avatar__icon' }, React__default['default'].createElement(Icon$d, { name: icon }));
};
...
var Avatar$1 = function Avatar(props) {
  ...
  var avatarClass = classNames__default['default']('a-avatar', _defineProperty$f({}, '' + sizeClasses$9[size], !!size), className);

  return React__default['default'].createElement('div', { className: avatarClass, style: style, 'data-qa': qa }, icon && React__default['default'].createElement(IconWrapper$1, { icon: icon }), letter && React__default['default'].createElement(LetterWrapper$1, { letter: letter }), image && React__default['default'].createElement('img', { src: image, alt: alt }), children, React__default['default'].createElement('span', { className: 'u-screen-reader-only' }, ariaLabel));
};
  ...
  _createClass$k(Button, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('button', {
        ...
        type: htmlType,
        'aria-label': ariaLabel,
        'data-qa': qa }, icon ? React__default['default'].createElement(Icon$d, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon$d, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon$d, { name: iconRight }) : null, children);
    }
  }]);
...
var Flyout$1 = function (_Component) {
  ...
  function Flyout() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$1$8(this, (_ref = Flyout.__proto__ || Object.getPrototypeOf(Flyout)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return classNames__default['default'](_this.props.className, 'm-flyout', 'm-flyout--' + _this.props.direction, _defineProperty$2$3({
        'is-open': _this.state.isOpen,
        'm-flyout--scrollable': _this.props.scrollable
  ...
  _createClass$1$8(Flyout, [{
    ...
    value: function render() {
      ...
      var flyoutClass = this.getClassNames();
      return trigger && React__default['default'].createElement('div', { className: flyoutClass, ref: this.flyoutRef, 'aria-haspopup': 'true', 'aria-expanded': open, 'data-qa': qa }, React__default['default'].createElement('div', { onClick: this.toggleIsOpen }, this.props.trigger), React__default['default'].createElement(FlyoutContent$3, { hasPadding: hasPadding }, children));
    }
  }]);
...
var UserNavigation = function UserNavigation(props) {
  ...
  return React__default['default'].createElement('ul', { className: 'm-nav-list m-nav-list--left' }, React__default['default'].createElement('li', null, React__default['default'].createElement('a', { href: notificationsUrl(), title: 'Notificaties', alt: 'Klik hier om uw notificaties te bekijken.' }, 'Notificaties', notificationsCount > 0 && React__default['default'].createElement('span', null, ' (', notificationsCount, ')'))), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { href: aProfileUrl(), title: 'A-profiel beheren', alt: 'Hier krijgt u toegang tot uw A-profiel en uw persoonlijke instellingen.' }, 'A-profiel beheren')), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { href: favoritesUrl(), title: 'Favorieten', alt: 'Klik hier om uw favorieten te bekijken.' }, 'Favorieten')), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { href: linkingUrl(), title: 'Koppelingen', alt: 'Klik hier om uw eID, A-kaart en meer te koppelen.' }, 'Koppelingen')), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { href: myEloketUrl(), title: 'Mijn e-loket', alt: 'Mijn e-loket' }, 'Mijn e-loket')), children);
};
...
var UserMenu = function (_Component) {
  ...
  _createClass$2$4(UserMenu, [{
    ...
    value: function renderAvatar() {
      ...
      return React__default['default'].createElement(Avatar$1, {
        image: avatarUrl,
    ...
    value: function renderBadge() {
      ...
      return React__default['default'].createElement('a', {
        ...
        href: notificationsUrl() }, notificationsCount, React__default['default'].createElement('span', { className: 'u-screen-reader-only', 'data-translate': '' }, ' notificaties'));
    }
  }, {
    ...
    value: function renderLoggedInButton() {
      ...
      return React__default['default'].createElement(Button$7, { className: 'a-button-negative a-button__avatar o-header__button' }, React__default['default'].createElement('div', { className: 'a-avatar-wrapper' }, this.renderAvatar(), React__default['default'].createElement('p', null, firstName, '\xA0', lastName)));
    }
  }, {
    key: 'renderProfile',
    value: function renderProfile() {
      ...
      return React__default['default'].createElement('div', { className: 'u-text-center u-margin-top' }, React__default['default'].createElement(Avatar$1, {
        image: avatarUrl,
        icon: avatarUrl ? null : 'user',
        alt: 'avatar',
        width: '48',
        height: '48'
      }), React__default['default'].createElement('p', { className: 'u-margin-top-xs u-margin-bottom h5' }, firstName + ' ' + lastName));
    }
  }, {
    key: 'renderLoggedIn',
    value: function renderLoggedIn() {
      ...
      return React__default['default'].createElement('div', { className: 'm-user-menu-flyout' }, notificationsCount > 0 && this.renderBadge(), React__default['default'].createElement(Flyout$1, {
        trigger: this.renderLoggedInButton(),
        direction: 'right',
        hasPadding: false,
        size: flyoutSize }, React__default['default'].createElement('div', { className: 'u-margin' }, this.renderProfile(), !this.props.hideExternalLinks && React__default['default'].createElement(UserNavigation, { notificationsCount: notificationsCount, children: children }), React__default['default'].createElement(Button$7, {
    ...
    value: function renderLoggedOut() {
      ...
      return React__default['default'].createElement(Button$7, {
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('div', { style: { textAlign: this.props.direction }, 'data-qa': qa }, this.props.loggedIn ? this.renderLoggedIn() : this.renderLoggedOut());
    }
  }]);
...
var Accordion = function Accordion(_ref) {
  var children = _ref.children,
      qa = _ref.qa;
  return React__default['default'].createElement("div", { className: "m-accordion", "data-qa": qa }, children);
};
  ...
  _createClass$l(AccordionTab, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('div', {
        ...
        className: classNames__default['default']('m-accordion__tab', { 'is-open': isOpen })
      }, children);
    }
  }]);
...
var AccordionTabContent = function AccordionTabContent(_ref) {
  var children = _ref.children,
      qa = _ref.qa;
  return React__default['default'].createElement("div", { className: "m-accordion__content", "data-qa": qa }, React__default['default'].createElement("div", { className: "u-margin" }, children));
};

var AccordionTabHeader = function AccordionTabHeader(_ref) {
  var children = _ref.children,
      qa = _ref.qa;
  return React__default['default'].createElement("div", { className: "m-accordion__header", "data-qa": qa }, children);
};
  ...
  _createClass$m(Button, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('button', {
        ...
        type: htmlType,
        'aria-label': ariaLabel,
        'data-qa': qa }, icon ? React__default['default'].createElement(Icon$e, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon$e, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon$e, { name: iconRight }) : null, children);
    }
  }]);
...
var Modal = function (_React$Component) {
  ...
  _createClass$1$9(Modal, [{
    ...
    value: function addProps(Comp, props) {
      return React__default['default'].createElement(Comp.type, _extends$6({}, Comp.props, props));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      }) : React__default['default'].createElement(Button$8, { type: 'primary', onClick: function onClick() {
          return _this5.handleToggleModal(true);
        } }, triggerText);

      var sizeClass = sizes[size];

      return React__default['default'].createElement('div', null, modalTrigger, React__default['default'].createElement(ReactModal__default['default'], {
        ...
        role: 'dialog',
        'aria-modal': 'true',
        className: classNames__default['default']('m-modal', sizeClass, className),
        overlayClassName: classNames__default['default']('m-overlay', 'is-active', overlayClassName),
        'data-qa': qa,
      ...
      }, React__default['default'].createElement('div', { className: 'm-modal__content' }, (title || hasCloseButton) && React__default['default'].createElement('div', { className: 'm-modal__header u-margin-bottom-xs' }, title && React__default['default'].createElement('h6', null, title), hasCloseButton && React__default['default'].createElement(Button$8, { className: 'm-modal__close', icon: 'times', type: 'default', transparent: true, onClick: function onClick() {
          return _this5.handleRequestClose();
        } })), children && React__default['default'].createElement('div', { className: 'u-margin-bottom' }, children), (confirmText || denyText) && React__default['default'].createElement('div', { className: 'm-modal__footer' }, confirmText && React__default['default'].createElement(Button$8, { className: 'm-modal__confirm', onClick: this.handleConfirm }, confirmText), denyText && React__default['default'].createElement(Button$8, { className: 'm-modal__deny', outline: true, onClick: this.handleDeny }, denyText)))));
    }
  }]);
...
var ContentBlock = function ContentBlock(_ref) {
  ...
  return React__default['default'].createElement('div', { className: 'col-xs-' + xs + ' col-sm-' + sm + ' col-md-' + md + ' col-lg-' + lg }, children);
};
...
var NavBlock = function NavBlock(_ref) {
  ...
  return React__default['default'].createElement('div', null, React__default['default'].createElement('h5', { className: 'u-margin-top-xs u-margin-bottom-xs' }, title), React__default['default'].createElement('ul', { className: 'a-list a-list--lined has-icon-right' }, children));
};
  ...
  _createClass$n(Button, [{
    ...
    value: function render() {
      ...
      return React__default['default'].createElement('button', {
        ...
        type: htmlType,
        'aria-label': ariaLabel,
        'data-qa': qa }, icon ? React__default['default'].createElement(Icon$f, { name: icon }) : null, iconLeft ? React__default['default'].createElement(Icon$f, { name: iconLeft }) : null, iconRight ? React__default['default'].createElement(Icon$f, { name: iconRight }) : null, children);
    }
  }]);
...
var ButtonBlock = function ButtonBlock(_ref) {
  ...
  return React__default['default'].createElement('div', { className: 'u-margin-bottom' }, React__default['default'].createElement('h5', { className: 'u-margin-top-xs u-margin-bottom' }, title), React__default['default'].createElement(Button$9, { type: 'primary', role: 'link', title: buttonTitle, onClick: function onClick() {
      return redirect(url);
...
var generateSocialLinkFor = function generateSocialLinkFor(_ref) {
  ...
  return React__default['default'].createElement('a', {
    ...
    title: name,
    'aria-label': name,
    rel: 'external noopener noreferrer' }, React__default['default'].createElement(Icon$1$3, { name: name }));
};
...
var SocialBlock = function SocialBlock(_ref2) {
  ...
  return React__default['default'].createElement(React__default['default'].Fragment, null, React__default['default'].createElement('h5', { className: 'u-margin-bottom-xs' }, title), React__default['default'].createElement('div', null, generateSocialLinkFor({ name: 'facebook', handle: facebook }), generateSocialLinkFor({ name: 'twitter', handle: twitter }), generateSocialLinkFor({ name: 'instagram', handle: instagram }), generateSocialLinkFor({ name: 'linkedin', handle: linkedIn })));
};
...
var AstadSubFooter = function AstadSubFooter() {
  return React__default['default'].createElement(React__default['default'].Fragment, null, React__default['default'].createElement(ContentBlock, { xs: 12, sm: 4, md: 4 }, React__default['default'].createElement(NavBlock, { title: 'Snel zelf regelen' }, React__default['default'].createElement('li', null, React__default['default'].createElement('a', { title: 'Vraag een document aan', href: Environment$2.getEloketUrl() + '/nl/eloket/overzicht' }, 'Documenten aanvragen ', React__default['default'].createElement(Icon$1$3, { name: 'chevron-right' }))), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { title: 'Meld een sluikstort', href: Environment$2.getEloketUrl() + '/nl/eloket/sluikstort' }, 'Sluikstort melden ', React__default['default'].createElement(Icon$1$3, { name: 'chevron-right' }))), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { title: 'Geef een adreswijziging door', href: Environment$2.getEloketUrl() + '/nl/eloket/aangifte-adreswijziging-nieuw' }, 'Adreswijziging doorgeven ', React__default['default'].createElement(Icon$1$3, { name: 'chevron-right' }))), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { title: 'Regel een parkeerverbod', href: Environment$2.getEloketUrl() + '/nl/e-loket/parkeerverbod' }, 'Parkeerverbod aanvragen ', React__default['default'].createElement(Icon$1$3, { name: 'chevron-right' }))))), React__default['default'].createElement(ContentBlock, { xs: 12, sm: 4, md: 4 }, React__default['default'].createElement(NavBlock, { title: 'Dienstverlening' }, React__default['default'].createElement('li', null, React__default['default'].createElement('a', { title: 'Naar het e-loket', href: Environment$2.getEloketUrl() + '/nl/eloket/overzicht/' }, 'E-loket ', React__default['default'].createElement(Icon$1$3, { name: 'chevron-right' }))), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { title: 'Maak een afspraak', href: Environment$2.getEloketUrl() + '/nl/e-loket/afspraak-maken' }, 'Afspraak ', React__default['default'].createElement(Icon$1$3, { name: 'chevron-right' }))), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { title: 'Maak een melding', href: Environment$2.getEloketUrl() + '/nl/melden' }, 'Melding maken ', React__default['default'].createElement(Icon$1$3, { name: 'chevron-right' }))), React__default['default'].createElement('li', null, React__default['default'].createElement('a', { title: 'Naar openingsuren', href: Environment$2.getAstadUrl() + '/nl/overzicht/adressen-en-openingsuren/stadsloketten' }, 'Openingsuren ', React__default['default'].createElement(Icon$1$3, { name: 'chevron-right' }))))), React__default['default'].createElement(ContentBlock, { xs: 12, sm: 4, md: 4 }, React__default['default'].createElement(ButtonBlock, {
    title: 'Contact met stad Antwerpen',
    icon: 'envelope-o',
    buttonTitle: 'Overzicht contactmogelijkheden stad Antwerpen',
    url: Environment$2.getAstadUrl() + '/info/5360f244b1a8a76a088b45c4/contacteer-stad-antwerpen-voor-meer-info' }, 'Contacteer ons'), React__default['default'].createElement(ButtonBlock, {
    title: 'Schrijf u in op onze nieuwsbrief',
    buttonTitle: 'Schrijf u in op de antwerpen.be-nieuwsbrief',
    url: Environment$2.getAstadUrl() + '/info/56cda8a3aba8a7f8158b4778' }, 'Antwerpen.be - nieuwsbrief'), React__default['default'].createElement(SocialBlock, {
    title: 'Vind ons op',
...
var StandardSubFooter = function StandardSubFooter(_ref) {
  ...
  switch (type) {
    case 'antwerpen':
      return React__default['default'].createElement(AstadSubFooter, null);
    default:
      return React__default['default'].createElement(AstadSubFooter, null);
  }
};
...
var SubFooter = function SubFooter(_ref) {
  ...
  if (type) {
    return React__default['default'].createElement(StandardSubFooter, { type: type, 'data-qa': qa });
  }

  return React__default['default'].createElement('div', { className: 'aui-footer', 'data-qa': qa }, React__default['default'].createElement('div', { className: 'u-container' }, React__default['default'].createElement('div', { className: 'row u-margin-bottom-xs' }, children)));
};
...
var Pagination = function (_Component) {
  ...
  _createClass$o(Pagination, [{
    ...
    value: function render() {
      ...
      var paginationClasses = classNames__default['default']('m-pagination', styling);
      var previousDisabledClasses = classNames__default['default']('pagination-button', 'pagination-prev-page', {
        'is-disabled': currentPage <= 1
      });
      var nextDisabledClasses = classNames__default['default']('pagination-button', 'pagination-next-page', {
      ...
      return React__default['default'].createElement('nav', { role: 'navigation', 'aria-label': ariaLabel, 'data-qa': qa }, React__default['default'].createElement('ul', { className: paginationClasses }, React__default['default'].createElement('li', { className: 'm-pagination__prev pagination-button', key: 'pagination__prev' }, React__default['default'].createElement(Link$3, {
      ...
      }, React__default['default'].createElement(Icon$g, { name: 'angle-left', ariaLabel: ariaLabelPreviousPage }))), display === 'text' && React__default['default'].createElement('li', { className: 'm-pagination__label', key: 'pagination__label' }, currentPage + ' - ' + totalPages), display === 'numbers' && numbers.map(function (number, i) {
        if (number === '...') {
          return React__default['default'].createElement('li', { key: i }, '...');
        } else {
          return React__default['default'].createElement('li', { key: i }, React__default['default'].createElement(Link$3, {
            className: classNames__default['default']({ 'is-active': number === '' + currentPage }, 'pagination-button', 'pagination-button-' + i),
            href: '#',
            onClick: function onClick(e) {
      ...
      }), React__default['default'].createElement('li', { className: 'm-pagination__next pagination-button', key: 'pagination__next' }, React__default['default'].createElement(Link$3, {
      ...
      }, React__default['default'].createElement(Icon$g, { name: 'angle-right', ariaLabel: ariaLabelNextPage })))));
    }
  }]);
...
exports.AccordionTabContent = AccordionTabContent;
exports.AccordionTabHeader = AccordionTabHeader;
exports.Alert = Alert;
...
exports.Environment = Environment$3;
...
exports.TagListItem = TagListItem$1;
